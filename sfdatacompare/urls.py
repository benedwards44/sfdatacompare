...
urlpatterns = [
    ...
    url(r'^comparing-data/(?P<job_id>[0-9A-Za-z_\-]+)/$', views.CompareData.as_view(), name='comparing_data'),
    ...
    #url(r'^data-compare-result/(?P<job_id>[0-9A-Za-z_\-]+)/(?P<data_compare_job_id>\d+)/$', 'comparedata.views.execute_data_compare'),
]
